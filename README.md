...
```toml
# University Town auth server 10.0.3.2; Longdong / Dongfeng Road use 10.0.3.6
...
server = "10.0.3.2"                      # University Town; Longdong/Dongfeng Road 10.0.3.6
port = 61440
interval_secs = 20
